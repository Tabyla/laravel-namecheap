...
return [
    ...
    */
    ...
    'API Key is invalid or API access has not been enabled' => 'Ключ API недействителен или доступ к API не был включен',
    'Your new password does not meet the necessary requirements.' => 'Ваш новый пароль не соответствует необходимым требованиям.',
    'Passwords dont match or the user is currently locked.' => 'Пароли не совпадают, или пользователь в данный момент заблокирован.',
    'This password has been used previously for this account. Please choose a new password.' => 'Этот пароль уже использовался ранее для этой учетной записи. Пожалуйста, выберите новый пароль.',
